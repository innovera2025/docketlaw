      ...
      <div class="flex items-center gap-2 flex-nowrap">
        ...
        >
          <input
            ...
            class="peer relative min-h-[25px] min-w-[25px] cursor-pointer appearance-none rounded-md border border-primary transition-all checked:border-b border-grey-highlightlue checked:bg-blue checked:before:bg-blue"
