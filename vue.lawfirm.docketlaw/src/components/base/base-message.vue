...
import { ref } from 'vue'
import { getProfileImage } from '@/utils/profile-image'
  ...
  >
    ...
    <div class="flex items-center justify-between gap-[10px] mb-[5px]">
      <div class="flex gap-[10px]">
        ...
        >
          <img
            v-if="getProfileImage(profile_img_position)"
            :src="getProfileImage(profile_img_position)"
            class="size-full object-cover"
            alt=""
          />
          <div v-else class="text-white font-bold text-[25px]">{{ '?' }}</div>
        </div>
        <div class="">
